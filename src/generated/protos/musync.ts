...
export const PlayQueue: MessageFns<PlayQueue> = {
  encode(message: PlayQueue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).int32(message.id);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlayQueue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Track: MessageFns<Track> = {
  encode(message: Track, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.localSrc !== undefined) {
      LocalSource.encode(message.localSrc, writer.uint32(82).fork()).join();
    }
    if (message.neteaseSrc !== undefined) {
      NeteaseSource.encode(message.neteaseSrc, writer.uint32(90).fork()).join();
    }
    return writer;
  },
...
export const NeteaseSource: MessageFns<NeteaseSource> = {
  encode(message: NeteaseSource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NeteaseSource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LocalSource: MessageFns<LocalSource> = {
  encode(message: LocalSource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.path !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LocalSource {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Picture: MessageFns<Picture> = {
  encode(message: Picture, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Picture {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeletePlaylistsRequest: MessageFns<DeletePlaylistsRequest> = {
  encode(message: DeletePlaylistsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    writer.uint32(10).fork();
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeletePlaylistsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPlaylistsRequest: MessageFns<QueryPlaylistsRequest> = {
  encode(message: QueryPlaylistsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPlaylistsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateTrackResponse: MessageFns<CreateTrackResponse> = {
  encode(message: CreateTrackResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.track !== undefined) {
      Track.encode(message.track, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateTrackResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTracksRequest: MessageFns<QueryTracksRequest> = {
  encode(message: QueryTracksRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTracksRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TrackUpdate: MessageFns<TrackUpdate> = {
  encode(message: TrackUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.localSrc !== undefined) {
      LocalSource.encode(message.localSrc, writer.uint32(66).fork()).join();
    }
    if (message.neteaseSrc !== undefined) {
      NeteaseSource.encode(message.neteaseSrc, writer.uint32(74).fork()).join();
    }
    return writer;
  },
...
export const UpdateTrackRequest: MessageFns<UpdateTrackRequest> = {
  encode(message: UpdateTrackRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.update !== undefined) {
      TrackUpdate.encode(message.update, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateTrackRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateTrackResponse: MessageFns<UpdateTrackResponse> = {
  encode(message: UpdateTrackResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.track !== undefined) {
      Track.encode(message.track, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateTrackResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DeleteTracksRequest: MessageFns<DeleteTracksRequest> = {
  encode(message: DeleteTracksRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    writer.uint32(10).fork();
    for (const v of message.trackIds) {
      writer.int32(v);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteTracksRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryUsersRequest: MessageFns<QueryUsersRequest> = {
  encode(message: QueryUsersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryUsersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateUserRequest: MessageFns<UpdateUserRequest> = {
  encode(message: UpdateUserRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.update !== undefined) {
      UserUpdate.encode(message.update, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const DeleteUsersRequest: MessageFns<DeleteUsersRequest> = {
  encode(message: DeleteUsersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    writer.uint32(10).fork();
    for (const v of message.ids) {
      writer.int32(v);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteUsersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddLocalFolderRequest: MessageFns<AddLocalFolderRequest> = {
  encode(message: AddLocalFolderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.path !== "") {
      writer.uint32(10).string(message.path);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddLocalFolderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveLocalFolderRequest: MessageFns<RemoveLocalFolderRequest> = {
  encode(message: RemoveLocalFolderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.path !== "") {
      writer.uint32(10).string(message.path);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveLocalFolderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddLocalFolderResponse: MessageFns<AddLocalFolderResponse> = {
  encode(message: AddLocalFolderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddLocalFolderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveLocalFolderResponse: MessageFns<RemoveLocalFolderResponse> = {
  encode(message: RemoveLocalFolderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveLocalFolderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetTrackRequest: MessageFns<GetTrackRequest> = {
  encode(message: GetTrackRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).int32(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTrackRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetTrackCoverRequest: MessageFns<GetTrackCoverRequest> = {
  encode(message: GetTrackCoverRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetTrackCoverRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryLocalFoldersRequest: MessageFns<QueryLocalFoldersRequest> = {
  encode(_: QueryLocalFoldersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryLocalFoldersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LocalFolder: MessageFns<LocalFolder> = {
  encode(message: LocalFolder, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.path !== "") {
      writer.uint32(10).string(message.path);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LocalFolder {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreatePlayQueueRequest: MessageFns<CreatePlayQueueRequest> = {
  encode(message: CreatePlayQueueRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    writer.uint32(10).fork();
    for (const v of message.trackIds) {
      writer.int32(v);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreatePlayQueueRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreatePlayQueueResponse: MessageFns<CreatePlayQueueResponse> = {
  encode(message: CreatePlayQueueResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreatePlayQueueResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPlayQueueRequest: MessageFns<GetPlayQueueRequest> = {
  encode(_: GetPlayQueueRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetPlayQueueRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdatePlayerRequest: MessageFns<UpdatePlayerRequest> = {
  encode(message: UpdatePlayerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.manul !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdatePlayerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdatePlayQueueEvent: MessageFns<UpdatePlayQueueEvent> = {
  encode(message: UpdatePlayQueueEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    writer.uint32(10).fork();
    for (const v of message.trackIds) {
      writer.int32(v);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdatePlayQueueEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdatePlayerEvent: MessageFns<UpdatePlayerEvent> = {
  encode(message: UpdatePlayerEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.position !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdatePlayerEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SearchAllRequest: MessageFns<SearchAllRequest> = {
  encode(message: SearchAllRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SearchAllRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SearchAllResponse: MessageFns<SearchAllResponse> = {
  encode(message: SearchAllResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SearchAllResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RebuildIndexRequest: MessageFns<RebuildIndexRequest> = {
  encode(_: RebuildIndexRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
